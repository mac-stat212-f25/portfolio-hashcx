...
5.  Save the wrangled data to the `data/clean/` folder using `write_csv()`. Name this file `weather_clean.csv`. Look up the documentation for this function by typing `?write_csv` in the Console. You'll need to write an appropriate relative path.

```{r}
library(tidyverse)

weather <- read.csv(file = "../../data/raw/weather.csv")
...
weather |> 
  ...
  write_csv(file = "../../data/processed/weather_clean.csv")
